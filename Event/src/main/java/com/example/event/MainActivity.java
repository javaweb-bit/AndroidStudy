...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    @Override
    public boolean onTouchEvent(MotionEvent event) {  // Callback Method. Hierarchy Event Model
    ...
    @Override
    public boolean onKeyDown(int keyCode, KeyEvent event) { // Callback Method. Hierarchy Event Model
    ...
    @Override
    public void onClick(View v) {   // Delegation Event Model
        if(v==bellTextView){
    ...
    @Override
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) { // Delegation Event Model
